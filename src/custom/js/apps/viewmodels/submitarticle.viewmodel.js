...
Core.ViewModel.SubmitArticle = function() {
	...
	_self._submitArticleCallback = function(data) {
			if (data[0].success == '1') {
				window.location = "message.view.php?message=Successfully submitted article for review.";
			} else {
				window.location = "message.view.php?message=An error occured while trying to submit this article.";
			}
		};
