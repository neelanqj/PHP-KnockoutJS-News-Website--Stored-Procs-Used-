...
Core.Model.UserDetails = function(obj) {
	...
	_self.password2 = ko.observable(obj.password2 || '');
	_self.phone = ko.observable(obj.phone || '');
	_self.firstName = ko.observable(obj.firstName || '');
	_self.lastName = ko.observable(obj.lastName || '');
