...
<link rel="shortcut icon" href="../../logo.ico"></link>
	...
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/accountsettings.viewmodel.js' defer="defer"></script>  
   	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/accountsettings.page.js' defer="defer"></script>
</head>
