...
<body>
    ...
    <div class="row-fluid">
        <div class="span12 text-center">    
            ...
            <div class="row-fluid text-center">
            	<a href="http://PEooT.com/apps/view/link.view.php?id=" data-bind="attr: { href: 'http://rhanthos.ca/apps/view/link.view.php?id=' + articleid() }" target="_blank">
					<h2 data-bind="text: title"></h2><img class="bw" src="../../src/custom/img/articleclick_button.png">
				</a>
            </div>
   ...
   <div class="row-fluid">
	...
	<script type="text/html" id="comment-row">
			<div class="alert" data-bind="attr:{ class: userid == $.cookie('user_id') ? 'alert alert-info':'alert alert-success' } ">
				<div class="fluid-row">
