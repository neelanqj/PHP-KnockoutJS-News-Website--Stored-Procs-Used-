...
<link rel="shortcut icon" href="../../logo.ico"></link>
    ...
    <!-- Custom Script -->
    <script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/unreviewedarticles.viewmodel.js' defer="defer"></script>  
   	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/unreviewedarticles.page.js' defer="defer"></script>
