...
<link rel="shortcut icon" href="../../logo.ico"></link>
	...
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/changepassword.viewmodel.js' defer="defer"></script>  
   	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/changepassword.page.js' defer="defer"></script>
</head>
